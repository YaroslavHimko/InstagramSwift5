...
//  InstagramClone
//
//  Created by Yaroslav Himko on 20.03.21.
...
enum FollowState {
    case following // indicated the current user is following the other user
    case not_following // indicated the current user is NOT following the other user
}
